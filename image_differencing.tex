...
\url{http://dmtn-006.lsst.io/en/latest/}}. This analysis demonstrates that the false
...
\citep{becker05} and ESSENCE \citep{miknaitis07}. While this software is very
...
differential chromatic refraction due to Earth's atmosphere. Nevertheless, in
...
``decorrelation''\footnote{\url{https://dmtn-021.lsst.io/}} or the \citet{zackay}
