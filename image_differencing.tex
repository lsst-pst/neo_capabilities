...
Here we summarize an analysis of image differencing performance based on DECam data and 
...
The total false positive rate anticipated for LSST is thus comparable to the rate of 
