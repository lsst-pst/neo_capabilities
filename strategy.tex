...
\item Candidate tracks are then filtered further (pruned from false tracks) using the initial orbit
         ...
         detections. Due to small expected astrometric errors (0.15 arcsec for the faintest objects,
         ...
         could pass IOD-based filtering is negligible, as well as the incompleteness induced by this 
