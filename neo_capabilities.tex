...
an expected false detection rate using DECam data and prototype LSST software. We validate
...
PHAs and find an expected completeness of 66\% for PHAs with $H<22$ 
