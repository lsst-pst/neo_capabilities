...
We find an expected baseline completeness of 66\% for PHAs with $H<22$ 
...
In particular, we find that extending the LSST survey by two additional years would increase the completeness for PHAs to 86\% (including those discovered by contemporaneous surveys), without jeopardizing other LSST science goals.
\end{abstract}
