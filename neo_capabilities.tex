...
\begin{abstract}
The Large Synoptic Survey Telescope (LSST) will discover small bodies throughout the Solar System,
increasing the number of known objects by at least an order of magnitude. Here we investigate the 
capabilities of LSST to discover Near-Earth Objects (NEOs), as these fast-moving objects
can be the most challenging to track and link, and discuss the expected yield of NEO discoveries
